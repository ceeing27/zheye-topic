<template>
  <div class="create-post-page container">
    ...
    <uploader
      ...
      class="d-flex align-items-center justify-content-center bg-white text-secondary w-100 my-4"
    >
      <row class="text-center">
        <h2>点击上传头图</h2>
        <p class="d-block">图片格式仅限jpg或png，大小请控制在1mb以下</p>
      </row>
